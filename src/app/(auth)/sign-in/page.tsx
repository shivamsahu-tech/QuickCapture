...
<div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 ">
  <div className='border-2 border-slate-300 m-auto p-6 rounded-md' >
    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <button className="flex mx-auto mt-5 justify-center rounded-md bg-white  px-3 py-1.5 text-sm/6 font-semibold text-black shadow-sm hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-300">Sign in As Guest</button>
